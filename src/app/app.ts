...
export class App {
  ...
  private readonly ALL_MAIN_NAV = [
    { label: 'Dashboard', icon: 'dashboard', route: '/dashboard', roles: ['ADMIN', 'PROJECT_MANAGER', 'SITE_ENGINEER', 'WORKER','ACCOUNTANT'] },
  ...
  private readonly ALL_BOTTOM_NAV = [
    ...
    { label: 'Settings', icon: 'settings', route: '/settings', roles: ['ADMIN','ACCOUNTANT','PROJECT_MANAGER','WORKER','SITE_ENGINEER'] },
  ];
